...
DATABASE_FILE = "trades.db" # Kullanılacak SQLite veritabanı dosyasının adı
...
TRADABLE_BALANCE_RATIO = 0.99  # TRADABLE_BALANCE_RATIO: Ticaret için kullanılacak USDT bakiyesinin oranı (örneğin, %80).
...
TRAILING_STOP_ACTIVATION_PERCENTAGE = 0.009
...
TRAILING_STOP_DISTANCE_PERCENTAGE = 0.008
...
TRAILING_STOP_CHECK_INTERVAL_SECONDS = 10 # TRAILING_STOP_CHECK_INTERVAL_SECONDS: TSL kontrol aralığı (saniye).
